...
contracts/RestakeManager.sol#L115
 ...
 - [ ] ID-226
Parameter [RenzoOracle.calculateRedeemAmount(uint256,uint256,uint256)._currentValueInProtocol](contracts/Oracle/RenzoOracle.sol#L137) is not in mixedCase

contracts/Oracle/RenzoOracle.sol#L137


 - [ ] ID-227
Parameter [RenzoOracle.lookupTokenAmountFromValue(IERC20,uint256)._token](contracts/Oracle/RenzoOracle.sol#L84) is not in mixedCase

contracts/Oracle/RenzoOracle.sol#L84
...
contracts/RestakeManager.sol#L524
 ...
 - [ ] ID-230
Parameter [RenzoOracle.lookupTokenValues(IERC20[],uint256[])._balances](contracts/Oracle/RenzoOracle.sol#L99) is not in mixedCase

contracts/Oracle/RenzoOracle.sol#L99


 - [ ] ID-231
Parameter [RenzoOracle.lookupTokenValue(IERC20,uint256)._token](contracts/Oracle/RenzoOracle.sol#L70) is not in mixedCase

contracts/Oracle/RenzoOracle.sol#L70
...
contracts/RestakeManager.sol#L303
 ...
 - [ ] ID-243
Parameter [RenzoOracle.setOracleAddress(IERC20,AggregatorV3Interface)._token](contracts/Oracle/RenzoOracle.sol#L57) is not in mixedCase

contracts/Oracle/RenzoOracle.sol#L57
...
contracts/Delegation/OperatorDelegator.sol#L164
 ...
 - [ ] ID-248
Parameter [RenzoOracle.setOracleAddress(IERC20,AggregatorV3Interface)._oracleAddress](contracts/Oracle/RenzoOracle.sol#L57) is not in mixedCase
...
@openzeppelin/contracts/token/ERC20/extensions/IERC20Permit.sol#L59
 ...
 - [ ] ID-255
Parameter [RenzoOracle.calculateMintAmount(uint256,uint256,uint256)._newValueAdded](contracts/Oracle/RenzoOracle.sol#L114) is not in mixedCase

contracts/Oracle/RenzoOracle.sol#L114
...
@openzeppelin/contracts-upgradeable/utils/introspection/ERC165Upgradeable.sol#L41
 ...
 - [ ] ID-268
Parameter [RenzoOracle.calculateMintAmount(uint256,uint256,uint256)._currentValueInProtocol](contracts/Oracle/RenzoOracle.sol#L114) is not in mixedCase

contracts/Oracle/RenzoOracle.sol#L114


 - [ ] ID-269
Parameter [RenzoOracle.lookupTokenValues(IERC20[],uint256[])._tokens](contracts/Oracle/RenzoOracle.sol#L99) is not in mixedCase
...
contracts/Delegation/OperatorDelegator.sol#L124
 ...
 - [ ] ID-272
Parameter [RenzoOracle.lookupTokenAmountFromValue(IERC20,uint256)._value](contracts/Oracle/RenzoOracle.sol#L84) is not in mixedCase

contracts/Oracle/RenzoOracle.sol#L84


 - [ ] ID-273
Parameter [RenzoOracle.initialize(IRoleManager)._roleManager](contracts/Oracle/RenzoOracle.sol#L47) is not in mixedCase

contracts/Oracle/RenzoOracle.sol#L47


 - [ ] ID-274
Parameter [RenzoOracle.lookupTokenValue(IERC20,uint256)._balance](contracts/Oracle/RenzoOracle.sol#L70) is not in mixedCase
...
contracts/Delegation/OperatorDelegator.sol#L106
 ...
 - [ ] ID-277
Parameter [RenzoOracle.calculateRedeemAmount(uint256,uint256,uint256)._existingEzETHSupply](contracts/Oracle/RenzoOracle.sol#L137) is not in mixedCase

contracts/Oracle/RenzoOracle.sol#L137


 - [ ] ID-278
Parameter [RenzoOracle.calculateRedeemAmount(uint256,uint256,uint256)._ezETHBeingBurned](contracts/Oracle/RenzoOracle.sol#L137) is not in mixedCase

contracts/Oracle/RenzoOracle.sol#L137


 - [ ] ID-279
Parameter [RenzoOracle.calculateMintAmount(uint256,uint256,uint256)._existingEzETHSupply](contracts/Oracle/RenzoOracle.sol#L114) is not in mixedCase
...
contracts/EigenLayer/libraries/BeaconChainProofs.sol#L70
 ...
 - [ ] ID-311
[RenzoOracle.INVALID_0_INPUT](contracts/Oracle/RenzoOracle.sol#L23) is never used in [RenzoOracle](contracts/Oracle/RenzoOracle.sol#L13-L147)

contracts/Oracle/RenzoOracle.sol#L23
